...
# --------------------------------------------------------------------------------------------------------------------
Logging.config('test', level=logging.DEBUG)
...
start = LocalizedDatetime.construct_from_iso8601("2023-10-01T00:00:00Z")
...
document = list(message_manager.find_for_topic(topic, start, end, None, False, None,
